...
- Two-coupling split. Lab 28: light did its job on the same unpacked bath; leftover did not stay vacuum 1/d². Small τ_GCM does not keep leftover vacuum-like. Labs 28–29 empty window was leftover rain stopping on LCM. Not earned as a same-σ split.
- Two-coupling window. Lab 29: window empty. Leftover never 1/d² on this three-λ grid once leftover rain stops on LCM. Far F live is other, not flatten. Lab 30 pass-through is the other coding (GCM misses LCM). Not earned as a finite-κ window.
...
Leftover-vs-d on the hex disk is at a stop. Two-aether pass-through is earned (lab 30): leftover GCM misses LCM → 1/d²; light still drains. Labs 28–29 empty window was leftover rain stopping on LCM. Still no flatten. Still no SN clock. Lab 23's slow fall was pair-mid spawn, not gap τ. Do not scan λ looking for a flatten. SN dilation stays parked; do not add a clock well or c(E). No next lab until Glen says go.
