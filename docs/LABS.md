...
- pathorder-twopop+light (local). Lab 56: path-order costs local 1/d² (χ² 1/d²=3.71 vs 1/d=10.50; far d=16 live 2.50σ). Not earned as preferred local coding; unordered two-pop (46–47/54) remains preferred. Hex path-order still earned (57).
...
stop-geo not earned (55). Path-order costs local 1/d² (56) but hex+light still earned (57). Unordered two-pop (46–47/54) remains preferred local coding. Flatten/SN/T parked. No next lab until Glen says go.
