...
- A sitting diffuse LCM halo. T = 0 packing is a crust; in 2D it blows off. Do not add T. Lab 32 packing SOURCE and lab 33 crust-as-physical-response demoted to F_pre ledger artifact (lab 40 double-count). Lab 41 conserving kick makes packing momentum real but sitting halo still not earned (no hydro this lab).
...
Conserving-kick earned; pair 1/d2 not earned under it. Two-media fork sharpened: leftover heat-without-momentum (31/40) keeps MI 1/d2 but packing is phantom; conserving kick makes packing momentum real but costs vacuum 1/d2. Do not add T. Do not scan lambda for flatten. No next lab until Glen says go.
