...
drop-not-reclass earned local+hex (61–62). Path-order reclass stays demoted locally. urhat-geo not earned under strict gate (63). Flatten/SN/T parked. No next lab until Glen says go.
