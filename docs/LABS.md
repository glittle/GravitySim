...
- A sitting diffuse LCM halo. T = 0 packing is a crust; in 2D it blows off. Do not add T. Lab 32 packing SOURCE and lab 33 crust-as-physical-response demoted to F_pre ledger artifact (lab 40 double-count). Sitting halo not earned under conserving kick (42 CRUST).
...
heatter-squeeze-1/r² not earned (48); dens is 1/r. Two-pop keeps 1/d²+light; packing SOURCE from heatters is not the old 1/r². Flatten/SN parked. No next lab until Glen says go.
