...
- A sitting diffuse LCM halo. T = 0 packing is a crust; in 2D it blows off. Do not add T. Lab 32 packing SOURCE and lab 33 crust-as-physical-response demoted to F_pre ledger artifact (lab 40 double-count). Sitting diffuse halo still not earned.
...
Lab 40 double-counted earned — F_pre packing drive is not physical in this coding. Packing/squeeze thread at a stop unless a conserving kick coding is designed on purpose (not now). Still no flatten, no SN. Do not add T. No next lab until Glen says go.
