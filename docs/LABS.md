...
38. Pre-hit F_pre dens vs MI cross-section (`--lcm-shadow-crosssection`). Wall clock: 1 min 23 s. Continue-through kernel as labs 37. r_mi in {0.5, 1.0, 2.0}. Isolated null at each: |F|/err=1.22 (0.5, one 4× MC-like), 0.83 (1), 0.99 (2); n_LCM_stop=0. Pair leftover at r_mi=1 stays 1/d². F_pre dens is 1/r² at each r_mi; F_miss dens unread/cancels at each. Rule fixed a priori: S = F_pre dens × r_mid² / r_mi²; earned only if ≥3 shells ≥2σ for every compared r_mi agree on every pair within 2σ. Six overlapping shells (r0≥2). S sits near −8×10⁻⁷ on all three radii. Two pairs fail: 2.35σ at r_mid=5.5 (0.5 vs 1), 2.17σ at r_mid=12 (1 vs 2). Not a monotonic grow/shrink with r_mi, but a priori rule fails. **pre-hit-cross-section not earned.** Honest caveat: S is roughly constant; the stamp is the strict rule, not a soft almost. Results in results/lcm_shadow_crosssection/. Labs 28–37 not overwritten.

39. F_pre requires MI absorption (--lcm-shadow-pre-absorb). Wall clock: 9.1 s. Same continue-through LCM kernel as lab 37 (r_mi=1, n=1.20, R_spawn=20). Two cases only. Opaque: leftover first-hit absorbs on MI; isolated |F|/err=0.83 (null); F_pre dens 1/r2 (8/8, chi2 1.86 vs 1/r 3.0e4); F_miss unread; recovers lab 37. Transparent: leftover continues through the MI; isolated |F|/err=0, n_MI=0, n_geom=29942 (same crossings, no absorb); F_pre tags geometric intersections but unread (0/8 >=2sigma, max |z|=1.97); F_miss unread — no fake 1/r2. pre-hit-requires-absorption earned. Results in results/lcm_shadow_pre_absorb/. Labs 28-38 not overwritten.

40. F_pre vs MI-hit momentum ledger (--lcm-shadow-momentum). Wall clock: 7.4 s. Same continue-through kernel as lab 37. Isolated |F|/err=0.83 (null). Deposit-on vs deposit-off MI leftover bit-identical (Delta F=0) — lab-31 identity; ledger does not reduce the ray. Will-hit sample n_will=29942. Per will-hit ray along u-hat: p_in=1, Delta p_LCM=0.08305+/-0.00146 (56.8 sigma), Delta p_MI=1.000 (full absorb), residual=p_in-(dP_LCM+dP_MI)=-0.08305+/-0.00146 (56.8 sigma). dP_LCM toward MI 0.0816+/-0.0014. Conserving fails. double-counted earned. F_pre is lab-31-style side ledger; packing from F_pre is not a physical force in this coding. Labs 32-33 packing SOURCE / CRUST used that ledger as hydro drive — demote: not earned as physical packing. Results in results/lcm_shadow_momentum/. Labs 28-39 not overwritten.

41. Conserving LCM kick (--lcm-shadow-conserving). Wall clock: 1 min 3 s. Deliberate fix after lab 40 double-count: LCM path deposit reduces ray momentum before MI absorb; path still continues (n_LCM_stop=0). Kick on all LCM deposits (will-hit and miss); lambda_heat=240; clamp to remaining. Isolated deposit-on |F|/err=1.01 (null); deposit-off 0.83; n_MI same 29942; weighted absorb 27548 vs 29942 — not bit-identical. Will-hit ledger: p_in=1, dP_LCM=0.0800+/-0.0014, dP_MI=0.9200+/-0.0014, residual=0. conserving-kick earned. Pair leftover: classifier not 1/d2 (chi2 1/d=8.23 vs 1/d2=8.93; 9/9 F>2sigma); far live at d=16 (3.40 sigma) — other, not flatten. pair-leftover-1/d2 not earned. Gravity cost of a real LCM kick. Labs 30-31 vacuum 1/d2 was without conserving LCM momentum tap. Results in results/lcm_shadow_conserving/. Labs 28-40 not overwritten.

42. Conserving-kick sit/crust/blow-off (--lcm-shadow-conserving-sit). Wall clock: 6.6 s. Lab-41 conserving kick drives mobile LCM at T=0. Isolated |F|/err=1.01 (null). Stamp CRUST. leftover-off sits; dust and full pile on MI skin. sitting-halo-with-conserving-kick not earned. Real kick still crusts like lab 33. Results in results/lcm_shadow_conserving_sit/.

43. Conserving kick + tired light (--lcm-shadow-conserving-light). Wall clock: 1 min 3 s. Isolated 1.01. Pair leftover 1/d (not 1/d2; not hunted). Light ΔE=0.205, smear=0, stretch=1; κ=0 holds. conserving+light earned. Results in results/lcm_shadow_conserving_light/.

44. Conserving kick-strength window (--lcm-shadow-conserving-window). Wall clock: 3.0 min. λ_heat in {480,240,80}. Isolated nulls 1.06, 1.01, 0.86. residual_along=0 and Δp_LCM live at all three; leftover other/1/d/other — never 1/d2. 0/3 PASS. conserving-1/d2-window empty. Not a flatten hunt. Results in results/lcm_shadow_conserving_window/.

45. Conserving-kick miss/pre partition (--lcm-shadow-conserving-missflux). Wall clock: 1 min (60.0 s). Lab-41 conserving kick; same shells as lab 37. Isolated |F|/err=1.01 (null). n_LCM_stop=0; n_MI=29942, weighted absorb 27548. F_pre dens: 1/r² earned (8/8 ≥2σ; χ² 1/r²=1.36 vs 1/r=2.56e4). F_miss dens: flat (3/8 ≥2σ; χ² flat=129 vs 1/r=298, 1/r²=410) — lab 37 was unread. Pair leftover control: 1/d (far live; not 1/d²; not hunted). conserving-F_pre-1/r² earned. Squeeze density law survives the real kick; not a phantom-ledger artifact. Pair vacuum 1/d² remains the gravity cost. Results in results/lcm_shadow_conserving_missflux/.

46. Two-population leftover (--lcm-shadow-twopop). Wall clock: 37.2 s. Fixed f=0.5 (refused any other). Heatters: first-hit stop on LCM. Passers: lab-30 pass-through to MI. Isolated |F|/err=0.47 (null). Pair leftover 1/d² (χ² 0.73 vs 1/d 8.82); far d=16 σ=1.26 (dead). Heatters: n_LCM_stop=2.03e6, heat_LCM=1.015e6; passers n_MI=14834. two-pop-split earned. Same-ray conserving cost was the hole; split restores MI 1/d² with real LCM absorption. Results in results/lcm_shadow_twopop/.

47. Two-pop leftover + tired light (--lcm-shadow-twopop-light). Wall clock: 40.3 s. Lab-46 coding: f=0.5 fixed, heatters first-hit stop, passers pass-through. Isolated |F|/err=0.47 (null). Pair leftover 1/d² (χ² 0.73 vs 8.82); far d=16 σ=1.26. Light: ΔE=0.205, smear_max=0, stretch=1; κ=0 holds. two-pop+light earned. Labs 28–29 empty window was all-ray LCM stop, not an inherent two-coupling ban. Results in results/lcm_shadow_twopop_light/.

48. Two-pop heatter-only squeeze dens (--lcm-shadow-twopop-squeeze). Wall clock: 36.8 s. Lab-46 coding f=0.5. Isolated |F|/err=0.47 (null). Pair leftover 1/d² (χ² 0.73 vs 8.82). Heatter-only F_dens: 6/8 shells ≥2σ inward; χ² 1/r=127.61 vs 1/r²=319.92, flat=6920. heatter-squeeze-1/r² not earned; best label 1/r. Real stops push LCM inward but do not recreate lab 34/37 phantom-ledger 1/r² SOURCE. Results in results/lcm_shadow_twopop_squeeze/.

49. Two-pop heatter-force sit/crust/blow-off (--lcm-shadow-twopop-sit). Wall clock: 3.9 s. Lab-46/48 heatter-stop drive; f=0.5; T=0 packing box as labs 33/42. Isolated |F|/err=0.47 (null). Stamp CRUST. leftover-off late <r>=5.871; dust on_MI=1; full <r>=1.369, on_MI=0.565, packed-floor=0.435. sitting-halo-with-heatter-force not earned. Real 1/r heatter drive still crusts like labs 33/42. Results in results/lcm_shadow_twopop_sit/.

50. Two-pop leftover outside extended hex disk (--lcm-shadow-twopop-ext). Wall clock: 1 min 12 s (72.0 s). Lab-21 filled hex disk + lab-46 two-pop f=0.5; frozen LCM R=80; origin-centered spawn R_spawn=39.2 (labs 25–27). Isolated (disk off) |F|/err=1.05 (null). Heatters: n_LCM_stop=2.28e6. Exterior F(d): other (χ² 1/d²=1.85 vs 1/d=1.45); far d=32 live 4.14σ repulsive. twopop-ext-1/d² not earned at 12e6. Two-pop does not yet carry lab-21 vacuum-like extended leftover at this sample. Not a flatten. CORRECTION (lab 53): Lab 50 exterior other at 12e6 was under-sampled; lab 53 at 48e6 with the same f=0.5 coding earns passer-ext and total 1/d². Results in results/lcm_shadow_twopop_ext/.

51. Vacuum hex leftover on lab-50 spawn (--lcm-shadow-twopop-ext-vac). Wall clock: 5.5 min (329.1 s). Same hex + R_spawn=39.2 as lab 50; LCM off. Isolated |F|/err=0.98 (null; one 4×). Exterior 1/d² (χ² 3.09 vs 1/d 16.60); far d=32 σ=1.42 attractive not live. n_LCM=0. vac-ext-spawn39-1/d² earned. Lab 50 hole is LCM/two-pop, not the shared spawn. Results in results/lcm_shadow_twopop_ext_vac/.

52. Hex+spawn39 LCM-on all-passers (--lcm-shadow-twopop-ext-pass). Wall clock: 5.5 min (328.2 s). Same hex + R_spawn=39.2 as labs 50–51; frozen LCM present; f=0 exactly (leftover ignores LCM). Isolated |F|/err=0.98 (null; one 4×). Exterior 1/d² (χ² 3.09 vs 16.60); far d=32 σ=1.42 not live. n_LCM_stop=0. passthrough-ext-1/d² earned. Heatters (lab 50), not LCM presence, caused exterior other. Results in results/lcm_shadow_twopop_ext_pass/.

53. Hex two-pop passer/total partition (--lcm-shadow-twopop-ext-partition). Wall clock: 5.7 min (343.3 s). Lab-50 geometry+f=0.5; one 4× to 48e6. Isolated F_pass |F|/err=1.39, F_tot=0.90 (nulls). Exterior F_pass 1/d² (χ² 2.32 vs 10.61); F_tot 1/d² (χ² 1.63 vs 6.46); far d=32 not live. n_pass/n_lab52=0.51 at d=5.5. passer-ext-1/d² earned. Lab 50 other was thin MC, not a physical heatter ban on extended leftover. Results in results/lcm_shadow_twopop_ext_partition/.

54. Two-pop + tired light on hex (--lcm-shadow-twopop-ext-light). Wall clock: 5.7 min (339.7 s). Lab-50/53 geometry; f=0.5; 48e6 leftover rays. Isolated |F|/err=0.90 (null). Exterior F_tot 1/d² (χ² 1.63 vs 6.46); far d=32 σ=1.75 not live. Light ΔE=0.205, smear_max=0, stretch=1; κ=0 holds. twopop-ext+light earned. Extended two-coupling matches local lab 47. Results in results/lcm_shadow_twopop_ext_light/.

55. Heatter stop geometry (--lcm-shadow-twopop-stop-geo). Wall clock: 3.6 s. Isolated 0.47. F_dens still 1/r. Pre-registered F_dens=-p n_stop/(V n_tot) fails (χ²_kin=5.53e5 vs zero 350). n_stop/V nearly flat. stop-geo-explains-1/r not earned. Results in results/lcm_shadow_twopop_stop_geo/.

56. Path-ordered two-pop + light local (--lcm-shadow-twopop-pathorder). Wall clock: 42.2 s. Heatter only if t_LCM < t_MI. Isolated 1.05. Pair leftover other (χ² 1/d²=3.71 vs 1/d=10.50; far d=16 live 2.50σ). Light ΔE=0.205 smear0 stretch1; κ=0. n_MI_heat=0; realized heatter frac=0.1692. pathorder-twopop+light not earned. Results in results/lcm_shadow_twopop_pathorder/.

57. Path-ordered two-pop + light on hex (--lcm-shadow-twopop-ext-pathorder). Wall clock: 5.8 min (349.6 s). 48e6 rays. Isolated 0.90. Exterior 1/d² (χ² 1.63 vs 6.46). Light PASS; κ=0; n_MI_heat=0. pathorder-ext+light earned. Results in results/lcm_shadow_twopop_ext_pathorder/.

58. Weighted stop kinematics (--lcm-shadow-twopop-stop-urhat). Wall clock: 3.5 s. Isolated 0.47. F_dens 1/r. Model F=p〈u·r̂〉n_stop/(V n_tot) matches (χ²_kin=0 vs zero 350). 〈u·r̂〉 −0.18 near MI to ~−0.01 far; n_stop/V flat. urhat-stop-explains-1/r earned. Results in results/lcm_shadow_twopop_stop_urhat/.

59. Path-order local autopsy (--lcm-shadow-twopop-pathorder-autopsy). Wall clock: 40.3 s. F_pass0 1/d² (χ² 0.73 vs 8.82; far 1.26σ). F_reclass other (far 2.81σ). F_tot other (far 2.50σ). n_MI_heat=0. reclass-causes-far-live earned. Results in results/lcm_shadow_twopop_pathorder_autopsy/.

60. Same-seed unordered vs path-order (--lcm-shadow-twopop-order-compare). Wall clock: 44.0 s. Unordered 1/d²; path-order other; light PASS. Isolated 0.47 / 1.05. unordered-preferred-local earned. Results in results/lcm_shadow_twopop_order_compare/.

61. Drop-not-reclass local + light (--lcm-shadow-twopop-drop). Wall clock: 42.1 s. MI-first intended heatters dropped (no MI, no LCM). Isolated 0.47. Pair 1/d² (χ² 0.73 vs 8.82). Light PASS; n_MI_heat=0; n_drop=13946 iso. drop-twopop+light earned. Results in results/lcm_shadow_twopop_drop/.

62. Drop-not-reclass hex + light (--lcm-shadow-twopop-ext-drop). Wall clock: 5.8 min (347 s). 48e6 rays. Isolated 1.39. Exterior 1/d² (χ² 2.32 vs 10.61). Light PASS; n_MI_heat=0; n_drop=87050. drop-ext+light earned. Results in results/lcm_shadow_twopop_ext_drop/.

63. 〈u·r̂〉 geometry (--lcm-shadow-twopop-urhat-geo). Wall clock: 3.5 s. Pre-registered isotropic Beer first-stop model. Isolated 0.47. χ²_geo=3.17 vs zero 200.78 on 6 live shells; gate χ²≤2 fails. urhat-geo not earned (shape right, not retuned). Results in results/lcm_shadow_twopop_urhat_geo/.

64. Realized heatter frac vs Beer path (--lcm-shadow-twopop-heatter-frac). Wall clock: 6.6 s. Local drop geometry; f=0.5 intent. Pre-registered P_pred=f∫(1-e^{-ℓ/λ})du on spawn-in-bath impact. Isolated 0.47. Pred 0.168975 vs meas 0.169238. heatter-frac-geo earned. Gap from 0.5 is bath-exit Beer (ℓ~100), not MI disk. Hex check pred 0.1898 vs lab-62 0.1899. Results in results/lcm_shadow_twopop_heatter_frac/.
...
- A sitting diffuse LCM halo. T = 0 packing is a crust; in 2D it blows off. Do not add T. Lab 32 packing SOURCE and lab 33 crust-as-physical-response demoted to F_pre ledger artifact (lab 40 double-count). Sitting halo not earned under conserving kick (42 CRUST). Sitting halo not earned under heatter force (49 CRUST).
- heatter-squeeze-1/r². Lab 48: heatter-only F_dens best label is 1/r (χ² 1/r=127.61 vs 1/r²=319.92); real stops push LCM inward but do not recreate lab 34/37 phantom-ledger 1/r² SOURCE. Not earned.
- stop-geo-explains-1/r. Lab 55: pre-registered F_dens=-p n_stop/(V n_tot) fails (χ²_kin=5.53e5 vs zero 350); n_stop/V nearly flat; F_dens still 1/r. Not earned.
- pathorder-twopop+light (local). Lab 56: path-order costs local 1/d² (χ² 1/d²=3.71 vs 1/d=10.50; far d=16 live 2.50σ). Labs 59–60: fail = reclass channel (F_pass0 still 1/d²; F_reclass other far-live). Not earned as preferred local coding; unordered preferred locally (60). Drop-not-reclass preferred local+hex (61–62). Hex path-order still earned (57).
- urhat-geo. Lab 63: pre-registered isotropic Beer first-stop model; χ²_geo=3.17 vs zero 200.78 on 6 live shells; gate χ²≤2 fails. Shape right, not retuned. Not earned under strict gate.
...
Lab 50 exterior other at 12e6 was under-sampled; lab 53 at 48e6 with the same f=0.5 coding earns passer-ext and total 1/d² (not a physical heatter ban on extended leftover).
...
heatter-frac-geo earned (64). Realized frac = f × P(stop before bath exit). Flatten/SN/T parked. No next lab until Glen says go.
